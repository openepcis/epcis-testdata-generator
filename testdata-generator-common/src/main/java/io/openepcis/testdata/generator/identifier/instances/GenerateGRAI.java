...
public class GenerateGRAI extends GenerateEPC {
  ...
  private List<String> generateIdentifiers(
    ...
    try {
      ...
      final String prefix =
          syntax.equals(IdentifierVocabularyType.URN) ? GRAI_URN_PART : dlURL + GRAI_URI_PART;
      ...
      if (SerialTypeChecker.isRangeType(this.serialType, count, this.rangeFrom)) {
        ...
        generateRandomIdentifiers(
            formattedGRAI, prefix, modifiedGRAI, delimiter, serialNumberGenerator, count);
      ...
      throw new TestDataGeneratorException(
          "Exception occurred during generation of GRAI instance identifiers : " + ex.getMessage(),
          ex);
    }
  }

  // Function to generate the GRAI range identifiers and return the list of identifiers
  private void generateRangeIdentifiers(
      final List<String> formattedGRAI,
      final String prefix,
  ...
  // Function to generate the GRAI Random identifiers based on seed and return the list of
  // identifiers
  private void generateRandomIdentifiers(
      final List<String> formattedGRAI,
      final String prefix,
      final String modifiedGRAI,
      final String delimiter,
    ...
    final List<String> randomSerialNumbers =
        serialNumberGenerator.randomGenerator(randomType, randomMinLength, randomMaxLength, count);
  ...
  private void generateStaticIdentifier(
      final List<String> formattedGRAI,
      final String prefix,
      final String modifiedGRAI,
      final String delimiter,
