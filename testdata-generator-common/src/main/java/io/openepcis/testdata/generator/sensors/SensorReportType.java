...
public class SensorReportType {
  ...
  public SensorReport format(final List<RandomGenerators> randomGenerators) {
    ...
    setStringValue(
        sensorReport, SensorReport::setCoordinateReferenceSystem, this.coordinateReferenceSystem);
  ...
  private void setDoubleValue(
      ...
      final ObjDoubleConsumer<SensorReport> setter,
      final ValueTypeSyntax valueType,
  ...
  private void setUriValue(
      final SensorReport sensorReport,
      final BiConsumer<SensorReport, URI> setter,
      final URI uriValue) {
    if (uriValue != null) {
  ...
  private void setStringValue(
      final SensorReport sensorReport,
      final BiConsumer<SensorReport, String> setter,
