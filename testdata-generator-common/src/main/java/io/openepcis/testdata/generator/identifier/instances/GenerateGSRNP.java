...
public class GenerateGSRNP extends GenerateEPCType2 {
  ...
  private List<String> generateIdentifiers(
    ...
    try {
      ...
      final String prefix =
          syntax.equals(IdentifierVocabularyType.URN) ? GSRNP_URN_PART : dlURL + GSRNP_URI_PART;
      ...
      throw new TestDataGeneratorException(
          "Exception occurred during generation of GSRNP instance identifiers : " + ex.getMessage(),
          ex);
    }
  }
}
