...
public class RandomGenerators implements Serializable {
  @Schema(type = SchemaType.NUMBER, description = "ID associated with the random generation type.")
  ...
  @JsonIgnore private TriangularDistribution triangularDistribution;
}
